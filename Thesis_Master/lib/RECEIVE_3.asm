...
include "m8c.inc"
include "memory.inc"
include "RECEIVE_3.inc"


;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export   RECEIVE_3_EnableInt
export  _RECEIVE_3_EnableInt
export   RECEIVE_3_DisableInt
export  _RECEIVE_3_DisableInt
export   RECEIVE_3_Start
export  _RECEIVE_3_Start
export   RECEIVE_3_Stop
export  _RECEIVE_3_Stop
export   RECEIVE_3_bReadRxData
export  _RECEIVE_3_bReadRxData
export   RECEIVE_3_bReadRxStatus
export  _RECEIVE_3_bReadRxStatus

; Old function name convension, do not use.
; These will be removed in a future release.
export  bRECEIVE_3_ReadRxData
export _bRECEIVE_3_ReadRxData
export  bRECEIVE_3_ReadRxStatus
export _bRECEIVE_3_ReadRxStatus

;-----------------------------------------------
; High Level RX functions
;-----------------------------------------------

export  RECEIVE_3_cGetChar
export _RECEIVE_3_cGetChar
export  RECEIVE_3_cReadChar
export _RECEIVE_3_cReadChar
export  RECEIVE_3_iReadChar
export _RECEIVE_3_iReadChar

IF (RECEIVE_3_RXBUF_ENABLE)
export  RECEIVE_3_CmdReset
export _RECEIVE_3_CmdReset
export  RECEIVE_3_bCmdCheck
export _RECEIVE_3_bCmdCheck
export  RECEIVE_3_bCmdLength
export _RECEIVE_3_bCmdLength
export  RECEIVE_3_bErrCheck
export _RECEIVE_3_bErrCheck

export  RECEIVE_3_szGetParam
export _RECEIVE_3_szGetParam
export  RECEIVE_3_szGetRestOfParams
export _RECEIVE_3_szGetRestOfParams

;-----------------------------------------------
;  Variables
;-----------------------------------------------

AREA RECEIVE_3_RAM(RAM,REL,CON)
 ptrParam:   			BLK  1
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_EnableInt
;
;  DESCRIPTION:
...
;
 RECEIVE_3_EnableInt:
_RECEIVE_3_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_EnableIntMask RECEIVE_3_INT_REG, RECEIVE_3_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 RECEIVE_3_DisableInt:
_RECEIVE_3_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask RECEIVE_3_INT_REG, RECEIVE_3_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_RECEIVE_3_Start:
   ...
   mov   REG[RECEIVE_3_CONTROL_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_RECEIVE_3_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[RECEIVE_3_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_bReadRxData
;
;  DESCRIPTION:
...
;    functions.
;
 RECEIVE_3_bReadRxData:
_RECEIVE_3_bReadRxData:
 bRECEIVE_3_ReadRxData:
_bRECEIVE_3_ReadRxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[RECEIVE_3_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 RECEIVE_3_bReadRxStatus:
_RECEIVE_3_bReadRxStatus:
 bRECEIVE_3_ReadRxStatus:
_bRECEIVE_3_ReadRxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[RECEIVE_3_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_cGetChar
;
;  DESCRIPTION:
...
.getChar_Loop:
   tst REG[RECEIVE_3_CONTROL_REG],RECEIVE_3_RX_REG_FULL   ; Check if a character is ready
   jz  .getChar_Loop                                        ; If not loop

   mov A, REG[RECEIVE_3_RX_BUFFER_REG]           ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;
...
;
 RECEIVE_3_cReadChar:
_RECEIVE_3_cReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1

   mov  A,REG[RECEIVE_3_CONTROL_REG]                       ; Get Status of RX
   push A
   and  A,RECEIVE_3_RX_COMPLETE                            ; Check if a character is ready
   jnz  .RX_DATA_RDY                                       ; Data Ready go read it.
   pop  A
   jmp  .RX_NO_VALID_CHAR

.RX_DATA_RDY:
   mov  A,REG[RECEIVE_3_RX_BUFFER_REG]                     ; Read data first, then
   swap A,X                                                ; determine if data is valid

   pop  A                                                  ; Check for errors
   and  A,(RECEIVE_3_RX_PARITY_ERROR | RECEIVE_3_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_iReadChar
;
...
;
 RECEIVE_3_iReadChar:
_RECEIVE_3_iReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1

   mov  A,REG[RECEIVE_3_CONTROL_REG]                       ; Get Status of RX
                                                           ; Mask only errors and data ready
   and  A,(RECEIVE_3_RX_ERROR|RECEIVE_3_RX_REG_FULL)
   push A
   and  A,RECEIVE_3_RX_COMPLETE                            ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,RECEIVE_3_RX_NO_DATA                             ; Add no data flag
   swap A,X
   jmp  End_RECEIVE_3_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,RECEIVE_3_RX_ERROR
   swap A,X
   mov  A,REG[RECEIVE_3_RX_BUFFER_REG]                     ; Read data first, then
                                                           ; determine if data is valid

 End_RECEIVE_3_iReadChar:
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_CmdReset
;
;  DESCRIPTION:
...
_RECEIVE_3_CmdReset:
   ...
   RAM_SETPAGE_CUR >RECEIVE_3_aRxBuffer
   mov [RECEIVE_3_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >ptrParam
   mov [ptrParam],0x00
   RAM_SETPAGE_CUR >RECEIVE_3_bRxCnt
   mov [RECEIVE_3_bRxCnt], 0x00
   and [RECEIVE_3_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_bCmdCheck
;
;  DESCRIPTION:
...
;
 RECEIVE_3_bCmdCheck:
_RECEIVE_3_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >RECEIVE_3_fStatus
   mov A,  [RECEIVE_3_fStatus]
   and A, RECEIVE_3_RX_BUF_CMDTERM               ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_bErrCheck
;
;  DESCRIPTION:
...
;
 RECEIVE_3_bErrCheck:
_RECEIVE_3_bErrCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >RECEIVE_3_fStatus
   mov A,  [RECEIVE_3_fStatus]
   and A, RECEIVE_3_RX_BUF_ERROR                 ; Mask off Error status
   and [RECEIVE_3_fStatus], ~RECEIVE_3_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_bCmdLength
;
;  DESCRIPTION:
...
;          CUR_PP
;
 RECEIVE_3_bCmdLength:
_RECEIVE_3_bCmdLength:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >RECEIVE_3_bRxCnt
   mov A,  [RECEIVE_3_bRxCnt]
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_szGetParam
;
;  DESCRIPTION:
...
;     RECEIVE_3_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, RECEIVE_3_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See RECEIVE_3_bCmdCheck).
;
...
;
 RECEIVE_3_szGetParam:
_RECEIVE_3_szGetParam:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_PROLOGUE RAM_USE_CLASS_3
   RAM_SETPAGE_CUR >ptrParam
   RAM_SETPAGE_IDX >RECEIVE_3_aRxBuffer

   mov  A, <RECEIVE_3_aRxBuffer             ; Get address to receive buffer
...
.CheckForDelim:
    cmp  A,RECEIVE_3_DELIMITER              ; Check if we have a delimiter
    jnz  .ParamStartFound
    inc  X                                  ; Increment both current pointer and
    inc  [ptrParam]                         ; stored pointer.
    mov  A,[X]                              ; Get character pointed by X
    cmp  [ptrParam],(RECEIVE_3_RX_BUFFER_SIZE -1)  ; Check if we are at the end of buffer
    jnz  .CheckForDelim
                                            ; End of string found
.EndOfString:
    push X                                  ; Save ptr
...
.ParamLoop:
    ...
    mov  [ptrParam],(RECEIVE_3_RX_BUFFER_SIZE -1)  ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A,>RECEIVE_3_aRxBuffer                     ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_3_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 RECEIVE_3_szGetRestOfParams:
_RECEIVE_3_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
