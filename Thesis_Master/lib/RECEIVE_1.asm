...
include "m8c.inc"
include "memory.inc"
include "RECEIVE_1.inc"


;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export   RECEIVE_1_EnableInt
export  _RECEIVE_1_EnableInt
export   RECEIVE_1_DisableInt
export  _RECEIVE_1_DisableInt
export   RECEIVE_1_Start
export  _RECEIVE_1_Start
export   RECEIVE_1_Stop
export  _RECEIVE_1_Stop
export   RECEIVE_1_bReadRxData
export  _RECEIVE_1_bReadRxData
export   RECEIVE_1_bReadRxStatus
export  _RECEIVE_1_bReadRxStatus

; Old function name convension, do not use.
; These will be removed in a future release.
export  bRECEIVE_1_ReadRxData
export _bRECEIVE_1_ReadRxData
export  bRECEIVE_1_ReadRxStatus
export _bRECEIVE_1_ReadRxStatus

;-----------------------------------------------
; High Level RX functions
;-----------------------------------------------

export  RECEIVE_1_cGetChar
export _RECEIVE_1_cGetChar
export  RECEIVE_1_cReadChar
export _RECEIVE_1_cReadChar
export  RECEIVE_1_iReadChar
export _RECEIVE_1_iReadChar

IF (RECEIVE_1_RXBUF_ENABLE)
export  RECEIVE_1_CmdReset
export _RECEIVE_1_CmdReset
export  RECEIVE_1_bCmdCheck
export _RECEIVE_1_bCmdCheck
export  RECEIVE_1_bCmdLength
export _RECEIVE_1_bCmdLength
export  RECEIVE_1_bErrCheck
export _RECEIVE_1_bErrCheck

export  RECEIVE_1_szGetParam
export _RECEIVE_1_szGetParam
export  RECEIVE_1_szGetRestOfParams
export _RECEIVE_1_szGetRestOfParams

;-----------------------------------------------
;  Variables
;-----------------------------------------------

AREA RECEIVE_1_RAM(RAM,REL,CON)
 ptrParam:   			BLK  1
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_EnableInt
;
;  DESCRIPTION:
...
;
 RECEIVE_1_EnableInt:
_RECEIVE_1_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_EnableIntMask RECEIVE_1_INT_REG, RECEIVE_1_bINT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 RECEIVE_1_DisableInt:
_RECEIVE_1_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask RECEIVE_1_INT_REG, RECEIVE_1_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_RECEIVE_1_Start:
   ...
   mov   REG[RECEIVE_1_CONTROL_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_RECEIVE_1_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[RECEIVE_1_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_bReadRxData
;
;  DESCRIPTION:
...
;    functions.
;
 RECEIVE_1_bReadRxData:
_RECEIVE_1_bReadRxData:
 bRECEIVE_1_ReadRxData:
_bRECEIVE_1_ReadRxData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[RECEIVE_1_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 RECEIVE_1_bReadRxStatus:
_RECEIVE_1_bReadRxStatus:
 bRECEIVE_1_ReadRxStatus:
_bRECEIVE_1_ReadRxStatus:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[RECEIVE_1_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_cGetChar
;
;  DESCRIPTION:
...
.getChar_Loop:
   tst REG[RECEIVE_1_CONTROL_REG],RECEIVE_1_RX_REG_FULL   ; Check if a character is ready
   jz  .getChar_Loop                                        ; If not loop

   mov A, REG[RECEIVE_1_RX_BUFFER_REG]           ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;
...
;
 RECEIVE_1_cReadChar:
_RECEIVE_1_cReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1

   mov  A,REG[RECEIVE_1_CONTROL_REG]                       ; Get Status of RX
   push A
   and  A,RECEIVE_1_RX_COMPLETE                            ; Check if a character is ready
   jnz  .RX_DATA_RDY                                       ; Data Ready go read it.
   pop  A
   jmp  .RX_NO_VALID_CHAR

.RX_DATA_RDY:
   mov  A,REG[RECEIVE_1_RX_BUFFER_REG]                     ; Read data first, then
   swap A,X                                                ; determine if data is valid

   pop  A                                                  ; Check for errors
   and  A,(RECEIVE_1_RX_PARITY_ERROR | RECEIVE_1_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_iReadChar
;
...
;
 RECEIVE_1_iReadChar:
_RECEIVE_1_iReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1

   mov  A,REG[RECEIVE_1_CONTROL_REG]                       ; Get Status of RX
                                                           ; Mask only errors and data ready
   and  A,(RECEIVE_1_RX_ERROR|RECEIVE_1_RX_REG_FULL)
   push A
   and  A,RECEIVE_1_RX_COMPLETE                            ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,RECEIVE_1_RX_NO_DATA                             ; Add no data flag
   swap A,X
   jmp  End_RECEIVE_1_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,RECEIVE_1_RX_ERROR
   swap A,X
   mov  A,REG[RECEIVE_1_RX_BUFFER_REG]                     ; Read data first, then
                                                           ; determine if data is valid

 End_RECEIVE_1_iReadChar:
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_CmdReset
;
;  DESCRIPTION:
...
_RECEIVE_1_CmdReset:
   ...
   RAM_SETPAGE_CUR >RECEIVE_1_aRxBuffer
   mov [RECEIVE_1_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >ptrParam
   mov [ptrParam],0x00
   RAM_SETPAGE_CUR >RECEIVE_1_bRxCnt
   mov [RECEIVE_1_bRxCnt], 0x00
   and [RECEIVE_1_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_bCmdCheck
;
;  DESCRIPTION:
...
;
 RECEIVE_1_bCmdCheck:
_RECEIVE_1_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >RECEIVE_1_fStatus
   mov A,  [RECEIVE_1_fStatus]
   and A, RECEIVE_1_RX_BUF_CMDTERM               ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_bErrCheck
;
;  DESCRIPTION:
...
;
 RECEIVE_1_bErrCheck:
_RECEIVE_1_bErrCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >RECEIVE_1_fStatus
   mov A,  [RECEIVE_1_fStatus]
   and A, RECEIVE_1_RX_BUF_ERROR                 ; Mask off Error status
   and [RECEIVE_1_fStatus], ~RECEIVE_1_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_bCmdLength
;
;  DESCRIPTION:
...
;          CUR_PP
;
 RECEIVE_1_bCmdLength:
_RECEIVE_1_bCmdLength:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >RECEIVE_1_bRxCnt
   mov A,  [RECEIVE_1_bRxCnt]
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_szGetParam
;
;  DESCRIPTION:
...
;     RECEIVE_1_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, RECEIVE_1_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See RECEIVE_1_bCmdCheck).
;
...
;
 RECEIVE_1_szGetParam:
_RECEIVE_1_szGetParam:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_PROLOGUE RAM_USE_CLASS_3
   RAM_SETPAGE_CUR >ptrParam
   RAM_SETPAGE_IDX >RECEIVE_1_aRxBuffer

   mov  A, <RECEIVE_1_aRxBuffer             ; Get address to receive buffer
...
.CheckForDelim:
    cmp  A,RECEIVE_1_DELIMITER              ; Check if we have a delimiter
    jnz  .ParamStartFound
    inc  X                                  ; Increment both current pointer and
    inc  [ptrParam]                         ; stored pointer.
    mov  A,[X]                              ; Get character pointed by X
    cmp  [ptrParam],(RECEIVE_1_RX_BUFFER_SIZE -1)  ; Check if we are at the end of buffer
    jnz  .CheckForDelim
                                            ; End of string found
.EndOfString:
    push X                                  ; Save ptr
...
.ParamLoop:
    ...
    mov  [ptrParam],(RECEIVE_1_RX_BUFFER_SIZE -1)  ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A,>RECEIVE_1_aRxBuffer                     ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RECEIVE_1_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 RECEIVE_1_szGetRestOfParams:
_RECEIVE_1_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
